/* PrismJS 1.30.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+bash+basic+batch+csharp+docker+fsharp+git+handlebars+json+markdown+markup-templating+mongodb+nginx+powershell+qsharp+regex+sql+t4-templating+t4-cs+t4-vb+vbnet+xml-doc+yaml */
